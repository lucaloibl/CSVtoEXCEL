...
def process_csv_file(file_path):
    ...
    try:
        ...
        '{EXPENSE_INSURANCE_WOHNGEBAEUDE}', '{EXPENSE_LEASING}', '{EXPENSE_LOAN}', '{EXPENSE_MICRO_LOAN}',
        ...
        '{CREDIT_LOAN}', '{CREDIT_MICRO_LOAN}', '{CREDIT_PARENTAL_SUPPORT}', '{CREDIT_PRIVATE_DRAWING}',
        ...
        '{DEBIT_OTHER_STANDING_ORDER}', '{DEBIT_RESTAURANT}', '{DEBIT_SAVING}', '{DEBIT_SCHUFA}',
